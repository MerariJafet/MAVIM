...
| Task | Role to assume | Model |
|------|---------------|-------|
| Starting a new project from scratch | MAVIM-Orchestrator → Planner (SOP_16/17) → Architect → Developers | Opus |
| Strategic planning, tech research | MAVIM-Planner (SOP_17 Web Intelligence) | Opus |
| Implementing a defined module | MAVIM-Developer | Sonnet |
| Creating a new SOP | MAVIM-Architect | Opus |
| Reviewing/auditing a SOP | MAVIM-Critic | Sonnet |
| Writing Python tooling | MAVIM-Developer | Sonnet |
| Integrating external standards | MAVIM-Orchestrator | Opus |
| Web scraping, data extraction | MAVIM-Scraper (SOP_17) | Haiku |
| Responding to community questions | DevRel (use `devrel/intelligence/draft_response.py`) | Sonnet |
| UI/UX design, components, animations | MAVIM-Developer + Skills: `ui-ux-pro-max`, `animation-libraries-expert` | Sonnet |
| 3D scenes, WebGL, particles, shaders | MAVIM-Developer + Skill: `threejs-skills` | Sonnet |
| Aesthetic surgery on existing UI | MAVIM-Orchestrator (SOP_07 + SOP_14 + SOP_08) | Opus |
...
| [**16**](core/SOP_16_CLAUDE_MODEL_ROUTING.md) | **CLAUDE_MODEL_ROUTING** | **Al asignar roles: Opus/Sonnet/Haiku por tarea** |
| [**17**](core/SOP_17_WEB_INTELLIGENCE.md) | **WEB_INTELLIGENCE** | **Al investigar tecnologías o extraer datos web** |
