...
5. **Refactoring Mode:** Si el usuario pide mejorar un código existente, carga el `core/SOP_07_REFACTORING.md`. Para proyectos existentes, el SOP_07 es la **ley suprema** y el `IMPACT_MAP.json` es el **primer entregable obligatorio**. Tu prioridad #1 es la integridad del sistema. No borres código sin antes mapear sus dependencias.
